...
An **AI Sandbox** is a temporary machine that is optimized for running untrusted LLM-generated code.

By default, it runs an OCI image made to make it easy to start working with LLM-generated code.
